...
3. `docker-compose.yml` – The currently active compose file you run (copy one of the templates above into this name).
...
- `docker-compose.yml` – Active file Docker Compose will use (create by copying one of the templates).
